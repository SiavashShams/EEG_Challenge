...
if __name__ == "__main__"
    ...
    dataset_folder = '/engram/naplab/shared/eeg_challenge_data_new'
    derivatives_folder = os.path.join(dataset_folder, 'derivatives')
    preprocessed_stimuli_folder = os.path.join(
        derivatives_folder, 'preprocessed_stimuli'
    )
    preprocessed_eeg_folder = os.path.join(
        derivatives_folder, 'preprocessed_eeg'
    )
